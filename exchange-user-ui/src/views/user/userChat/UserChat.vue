<template>
  <body>
	<div >
		<el-row >
			<el-col :xs="0" :sm="0" :md="6" :lg="6" :xl="6" class = "user_list">
				<el-card style=" height: 100%; color: #333">
					...
					<div style="padding: 0.5rem" v-for="user in users" :key="user.username">
			...
			<el-col :xs="24" :sm="24" :md="18" :lg="18" :xl="18" class = "user_list">
...
<style lang="less" scoped>
  ...
  body{
    background:url("chat.jpeg");
    background-repeat: no-repeat;
    background-attachment: fixed;
    background-size: 1500px, 1500px, cover, contain;
  }
  .user_list{
    opacity: 0.4;
  }
